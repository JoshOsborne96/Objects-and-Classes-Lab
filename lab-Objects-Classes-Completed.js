...
user.name = 'bryan.smith@devmounta.in'
...
let sphinx = new Cat('sphinx', 5, 'Black cat')
...
let Harry = new Wizard("Harry", 18, "leviosa")
// Harry.castSpell()
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
let phoneOne = new phone('AT&T', 'Razor', 32, 'Black', 150)
let phoneTwo = new phone('Verizon', 'Sidekick', 64, 'Green', 300)
let phoneThree = new phone('T-Mobile', 'Iphone', 64, 'red', 500)
...
let myFirstVehicle = new Vehicle(4, 'red', 60000)
...
myFirstMotorcycle = new Motocycle (2, 'Black', 20000, 'Harley Davidson', 'Yes')
...
let myFirstBoat = new Boat ('25', 'Green', 5000, 'Flying Dutchman', 'Pirate Ship', false)
